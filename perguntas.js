export const perguntas = [
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "sua primeira ação foi a criação de políticas efetivas para resolver o problema, mas deixou o preço médio dos produtos e serviços do país mais caros diminuindo a circulação de dinheiro junto a economia",
                ],
                proxima: 2,
            },
            {
    ...
    },
    {
        ...
        alternativas: [
        {
            ...
            afirmacao: [
                "e na hora para se pronunciar sobre o assunto disse que estava trabalhando arduamente para acabar com o problema.",
            ],
            proxima: 3,
        },
        {
            ...
            afirmacao: [
                "e na hora para se pronunciar sobre o assunto disse que estava fazendo o possível para resolver o problema."
            ],
            proxima: 3,
        },
     ]
        ...
        alternativas: [
            ...
            },
            {
                ...
                afirmacao: [
                    "Depois de repensar suas políticas para seu segundo mandato você decide focar na economia, mais especificamente no fim  da pobreza, apesar de um sucesso grandioso, as pesoas agora sofrem diariamente com a poluição diminuindo a expecttativa de vida da população, principalmente daqueles poucos que ainda continuam pobres",
                ],
                proxima: 4,
            },
        ]
